...
\begin{frame}
  ...
  \emph{Datenerfassung}
  \begin{itemize}
  	\item \emph{Temperatur über mind. 2 Sensoren}
  	\item \emph{Luftdruck}
  	\item \emph{Luftfeuchtigkeit}
  	\item \emph{Höhe über NN}
...
\begin{frame}
  ...
  \begin{itemize}
  	...
  	\item \emph{Wassergeschützter Aufbau}
...
\frametitle{Energieversorgung}
    \subsection{Versorgung}
        ...
        \begin{itemize}
            ...
            \item\emph{``no-name'' Blei-Säure Sekundärzelle}
        \end{itemize}
        \begin{figure}
    \centering
    \begin{minipage}[t]{0.45\linewidth}
...
\frametitle{Gehäuse}
        ...
        \emph{Idee:}
        \begin{itemize}
        	\item \emph{Gehäuse für Elektronik mittels 3D-Druck}
        	\item \emph{Überzug mit Bügelfolie}
        	\item \emph{Abdichtung der Ein- und Ausgänge}
        \end{itemize}
        \begin{figure}
        	\flushright
...
\begin{frame}
	\frametitle{Erfüllung der Anforderungen 1/2}
	\emph{Erfüllt}
	\begin{itemize}
		\item \emph{sämtliche Messwerte mit Sensoren abgedeckt}
		\item \emph{zusätzlicher Niederschlagssensor}
		\item \emph{Versorgung über ausgerichtetes Solarpanel}
		\item \emph{Pufferung des Ladeszustands}
		\item \emph{Positions- und Höhenbestimmung mittels GPS Modul}
...
\begin{frame}
	\frametitle{Erfüllung der Anforderungen 2/2}
	\emph{Eingrenzungen}
	\begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
  	...
  	\item \emph{Auswertung der Datenblätter}
  	\item \emph{Grundgerüst der Software}
   \end{itemize} 
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
  	...
  	\item \emph{Montage}
  	\item \emph{Gehäuse und Abdichtung}
  	\item \emph{Bericht}
  \end{itemize}  
\end{frame}
...
\begin{frame}[allowframebreaks]
  ...
  \emph{Datenblätter der jeweiligen Sensoren}
  %\bibliographystyle{plainnat}
  %\bibliography{literature} Ich hab nicht wirklich was zitiert, sollen wir das trotzdem angeben? Daten wären nur aus Datenblättern der Sensoren und dann die Werte für Druck und Temperatur, die aber Allgemeinwissen sind.
\end{frame}
